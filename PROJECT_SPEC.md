...
- **Sponsor structure:** industry vs. academic/public share; top sponsors.
  *Share answered; top sponsors still to do.* The database stores the sponsor
  ...
  cannot, and the rest is **`Unclassified` rather than forced** — 595 trials,
  5.0%. **Industry 9,456 (79.9%), academic or public 1,783 (15.1%).**
  ...
  **Industry's share is rising, 76.9% → 85.8%** — but the unclassified share
  fell from 7.9% to 2.7% over the same window as registry names got more
  complete, so part of that is trials becoming classifiable. Measured against
  classified trials only, the rise is **83.5% → 88.1%**, about half the crude
  ...
  *Top sponsors, once the families are merged.* 2,957 sponsors is a list of
  ...
  Roche under 13**, so a ranking of the raw column answers "which legal entity
  signed the most protocols" rather than "which company is behind the most
  Spanish trials". Merged: **Novartis 537, Roche 429, AstraZeneca 370, MSD 351,
...
- [x] Sponsor structure, part 2: top sponsors, with the corporate families
      merged (`FAMILIES` in `analysis/sponsors.py`)
